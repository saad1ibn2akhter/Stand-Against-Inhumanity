...
const NeedBlood = () => {
    ...
    const handleSearch = (e) => {
        ...
        const district = form.get('district').toLowerCase();

        const result = districts.filter(dis => dis.toLowerCase().includes(district));
    ...
    return (
        <div>
                    ...
                    <div className="relative bg-black bg-blend-multiply bg-opacity-60 pb-12">
                        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                            <div className="flex flex-col items-center justify-between xl:flex-row">
                                <div className="w-full max-w-xl font-mons mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                    <h2 className="max-w-lg mb-6  text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                                        <h1>Search for specific blood group</h1>
                                    </h2>
                                ...
                                <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                                    <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                        <h3 className="mb-4 text-xl font-semibold font-mons sm:text-center sm:mb-6 sm:text-2xl">
                                            Search blood using District name
                                        </h3>
                                        <form className='font-mons' onChange={handleSearch}>
            ...
            {/* all districts here */}
            <section className='font-mons mt-16'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 max-w-7xl mx-auto'>
                    {filteredDistricts.length > 0 ? (
                        filteredDistricts.map((district, index) => (
                            <Link to={`/bloodbank/needblood/${district}`}>
                                <div key={index} className='bg-green-50 border-green-400 border-[1px] text-red-500 flex space-x-2 items-center rounded-2xl p-2.5'>
                                    <img
                                        width="65"
                                        height="65"
...
const districts = [
    ...
    "Bandarban", "Feni", "Lalmonirhat", "Nilphamari", "Panchagarh", "Chuadanga",
    "Barguna"
];
