    ...
    return (
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 font-poppins">
            <div className=" mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="flex flex-col max-w-7xl lg:-translate-y-14 overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto">
            ...
            {/* <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
                <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
                    <Link to={'/blogdetails'} aria-label="Article">
                        <img
            ...
            <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
                {
                    blogs.map((blog, index) => <>
                        <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
                            <Link to={`/blogdetails/${blog?._id}`} aria-label="Article">
                                <img
                                    src={blog?.image1}
                                    className="object-cover w-full h-64 rounded"
                                    alt=""
